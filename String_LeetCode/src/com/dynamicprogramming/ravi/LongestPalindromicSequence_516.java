package com.dynamicprogramming.ravi;

import org.junit.Test;

public class LongestPalindromicSequence_516 {
	/**
	 * Here Backtrack and find the substring don't just return the size
	 * 
	 * @param input
	 * @return
	 */
	public static char[] LongestPalindromicSubsequence1(String input) {
		...
		// Filling up other than diagonal with Vivek's logic
		int l = 1;
	...
	public void testLongestPalindromicSubsequence() {
		...
		System.out.println(String.valueOf(LongestPalindromicSubsequence1(input)));
	}
